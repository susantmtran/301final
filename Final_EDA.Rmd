...
The variables with the highest levels of missingness are `actor4` and `actor5`. This is not surprising as some of the films represented in the data set are independently and/or fairly unknown, and therefore would not have the budget nor the need for a larger cast. Understandably, if a film does not have an `actor3`, it was also not have an `actor4` or an `actor5`.
...
Wrapping up our analysis of the data set, we find that \_\_\_\_\_\_\_\_. However, \_\_\_\_\_\_\_\_.
>>>>>>> 09c0a1a35925b3d00eefe9e47d91ba75d4b56d93
