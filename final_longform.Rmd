...
Overall, we are pleased with our model's ability to predict a film's Oscar nomination or lack thereof, given that there are various factors that lead to a nomination that may not be measurable with predictors in a data set. Additional data resources that could have helped improve model performance include a codebook - our data source did not provide one and we therefore did not gain as much context into the variables we were working with as we had initially hoped.
