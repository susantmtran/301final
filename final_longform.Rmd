...
<<<<<<< HEAD
In order to produce the best results, we tested five different models: K-nearest neighbor, boosted tree, random forest, elastic net, and neural net. First, we tested each model with two different recipes and found that the second recipe was more successful for every model.
=======
...
>>>>>>> cb86fa880d5c785378da3ecc70d3fb7ed68cd416
...
This is a slight decrease in performance for the accuracy, however it is still relatively high and we are pleased with the overall performance. The area under the ROC-AUC curve is also fairly high at 0.923 out of 1. 

# *Conclusion*

In conclusion, we are pleased with the results of our model. Add more
